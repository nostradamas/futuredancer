...
<form class="form-horizontal" id="objectDetailForm" role="form">
	<div class="row">
		...
		<input type="hidden" id="lid" name="lid" value="${bean.lid }">
        <input type="hidden" value="${uptoken}" id="uploadToken">
		<div class="form-group">
			<label  class="col-sm-3 control-label" for="linkName">链接名称</label>
			<div class="col-sm-4">
				<input type="text" class="form-control required"  id="linkName" name="linkName" placeholder="链接名称" value="${bean.linkName}">
			</div>
		</div>
		...
		<div class="form-group">
			<label  class="col-sm-3 control-label" for="linkUrl">链接地址</label>
			<div class="col-sm-4">
				<input type="text" class="form-control required"  id="linkUrl" name="linkUrl" placeholder="链接地址" value="${bean.linkUrl}">
			</div>
		</div>
		<div class="form-group">
...
$(function(){
	...
	var imageName = 'link-' + new Date().getTime(); //设置上传图片的名称前缀
