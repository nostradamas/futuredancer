...
var tableTitle = "视频课程信息";
var dataTablesDataUrl = SERVER_PATH + '/admin/class/getClassLists'; //数据url
var $toObjectDetailUrl = SERVER_PATH+'/admin/class/toClassDetail';//
var $saveObjectDetailUrl = SERVER_PATH + '/admin/class/classSave';
var $deleteObjectUrl = SERVER_PATH + '/admin/class/classDelete';
...
$(function() {
	var colsBindData = [
        {"data" : "cid"},
        {"data" : "name"},
        {"data" : "videoUrl", render:function(data,type,row,meta){
        	var videoUrl = '<a href="'+data+'" target="_blank">' + row.name + '</a>';
        	return videoUrl;
        }},
