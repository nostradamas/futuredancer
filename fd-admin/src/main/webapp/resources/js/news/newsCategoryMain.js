...
var tableTitle = "新闻分类信息";
var dataTablesDataUrl = SERVER_PATH + '/admin/news/getCateLists'; //数据url
var $toObjectDetailUrl = SERVER_PATH+'/admin/news/toCategoryDetail';//
var $saveObjectDetailUrl = SERVER_PATH + '/admin/news/categorySave';
var $deleteObjectUrl = SERVER_PATH + '/admin/news/categoryDelete';
...
function saveObjectDetail(){
	...
	//var objectDetailFormParam = $infoDetailForm.formSerialize();
	//objectDetailFormParam = objectDetailFormParam.replace(/event_/g, '');
