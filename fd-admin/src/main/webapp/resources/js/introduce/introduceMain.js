...
var tableTitle = "课程信息信息";
var dataTablesDataUrl = SERVER_PATH + '/admin/classIntroduce/getClassIntroduceLists'; //数据url
var $toObjectDetailUrl = SERVER_PATH+'/admin/classIntroduce/toClassIntroduceDetail';//
var $saveObjectDetailUrl = SERVER_PATH + '/admin/classIntroduce/classIntroduceSave';
var $deleteObjectUrl = SERVER_PATH + '/admin/classIntroduce/classIntroduceDelete';
