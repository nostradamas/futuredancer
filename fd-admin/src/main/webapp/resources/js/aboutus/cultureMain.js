...
var tableTitle = "公司文化信息";
var dataTablesDataUrl = SERVER_PATH + '/admin/aboutus/getCultureLists'; //数据url
var $toObjectDetailUrl = SERVER_PATH+'/admin/aboutus/toCultureDetail';//
var $saveObjectDetailUrl = SERVER_PATH + '/admin/aboutus/cultureSave';
var $deleteObjectUrl = SERVER_PATH + '/admin/aboutus/cultureDelete';
...
$(function() {
	var colsBindData = [
		...
		{"data" : "background", render:function(data,type,row,meta){
        	var img = '<img src="'+data+'" alt="'+ row.title + '" style="width:150px;"/>';
        	return img;
        }},
        {"data" : "sort"},
...
function saveObjectDetail(){
	...
	var img = $('#background').attr('key');
	var saveurl= $saveObjectDetailUrl;
	var $objectDetailForm = $("#objectDetailForm"); //数据表单
	var data = $objectDetailForm.serialize() + '&background='+ img;
	loading();
	$.ajax({
		type : 'POST',
		url : saveurl,
