...
<form class="form-horizontal" id="objectDetailForm" role="form">
	<div class="row">
		...
		<input type="hidden" id="uploadToken"  value="${uptoken}">
		...
		<div class="form-group">
			<label  class="col-sm-3 control-label" for="name">主讲师</label>
			<div class="col-sm-4">
				<input type="text" class="form-control"  id="teacher" name="teacher" placeholder="主讲师" value="${bean.teacher}">
			</div>
		</div>
		<div class="form-group">
...
$(function(){
	...
	var imageName = 'course-' + new Date().getTime(); //设置上传图片的名称前缀
